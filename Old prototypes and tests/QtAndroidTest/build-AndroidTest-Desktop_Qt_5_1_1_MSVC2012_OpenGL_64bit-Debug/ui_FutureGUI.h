...
public:
    ...
    void setupUi(QMainWindow *FutureGUIClass)
    {
        ...
        FutureGUIClass->resize(1280, 800);
        FutureGUIClass->setMinimumSize(QSize(1280, 800));
        FutureGUIClass->setMaximumSize(QSize(1280, 800));
        ...
        specialBtnR->setGeometry(QRect(370, 120, 55, 38));
        QIcon icon;
        ...
        stalkBtnR->setGeometry(QRect(370, 470, 55, 38));
        ...
        rootBtnR->setGeometry(QRect(370, 650, 55, 38));
        ...
        leafBtnR->setGeometry(QRect(370, 300, 55, 38));
        ...
        leafBtnL->setGeometry(QRect(40, 300, 55, 38));
        QIcon icon1;
        ...
        specialBtnL->setGeometry(QRect(40, 120, 55, 38));
        ...
        rootBtnL->setGeometry(QRect(40, 650, 55, 38));
        ...
        stalkBtnL->setGeometry(QRect(40, 470, 55, 38));
        ...
        saveBtn->setGeometry(QRect(1110, 20, 149, 90));
        QIcon icon2;
