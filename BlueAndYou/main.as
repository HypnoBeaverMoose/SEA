...
{	
	...
	public class main extends MovieClip
	{
		...
		private static const SCENE_OFFICE2:String = "office2_btn";
		...
		public function main()
		{
			...
			office2_btn.addEventListener( MouseEvent.CLICK, onSceneChoose );
		...
		private function onSceneChoose( e:MouseEvent ) : void
		{
			...
			} else if ( target.name == SCENE_OFFICE2 )
			{
				sceneType = Scene.OFFICE2;
