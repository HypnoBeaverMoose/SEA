...
public:
    ...
    void setupUi(QWidget *PlantGenGUI)
    {
        ...
        bgImg->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/genBG.png")));
        ...
        glowThorns->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/glowThorns.png")));
        ...
        glowRain->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/glowRain.png")));
        ...
        glowApple->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/glowApple.png")));
        ...
        glowTree->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/glowTree.png")));
        glowToy = new QLabel(centralWidget);
        glowToy->setObjectName(QStringLiteral("glowToy"));
        glowToy->setGeometry(QRect(693, 428, 198, 208));
        glowToy->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/glowToy.png")));
        ...
        flowerPlant1->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/flowerCactus.png")));
        ...
        flowerPlant2->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/flowerDustyMiller.png")));
        ...
        flowerPlant3->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/flowerTomato.png")));
        ...
        stalkPlant3->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/stalkTomato.png")));
        ...
        stalkPlant1->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/stalkCactus.png")));
        ...
        stalkPlant2->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/stalkDustyMiller.png")));
        ...
        leafPlant2->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/leafDustyMiller.png")));
        ...
        leafPlant3->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/leafTomato.png")));
        ...
        leafPlant1->setPixmap(QPixmap(QString::fromUtf8(":/PlantGen/Images/leafCactus.png")));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/PlantGen/Images/toPortraitBtn.png"), QSize(), QIcon::Normal, QIcon::Off);
