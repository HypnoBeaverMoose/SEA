...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VideoHandler_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 27, 11)
    ...
    "VideoHandler\0GoToPortrait\0\0handleError\0"
};
...
void VideoHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VideoHandler *_t = static_cast<VideoHandler *>(_o);
        switch (_id) {
        case 0: _t->GoToPortrait(); break;
...
const QMetaObject VideoHandler::staticMetaObject = {
    { &QStackedWidget::staticMetaObject, qt_meta_stringdata_VideoHandler.data,
      qt_meta_data_VideoHandler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoHandler.stringdata))
        return static_cast<void*>(const_cast< VideoHandler*>(this));
